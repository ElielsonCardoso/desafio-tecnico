...
public class PessoaTest {
    ...
    public void testPessoa(){
        ...
        enderecoResidencial.setId(2L);
        enderecoResidencial.setUf("PR");
        enderecoResidencial.setCep("87025540");
        enderecoResidencial.setNumero("7984");
        enderecoResidencial.setPessoa(pessoa);
        enderecoResidencial.setCidade("Maringá");
        enderecoResidencial.setLogradouro("Rua Poeta Carlos Drumond de Andrade, Parque Avenida");
